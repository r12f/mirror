...
KeyCode NativeKeyToKeyCode(WORD nNativeCode);
WORD KeyCodeToNativeKey(KeyCode nKeyCode);
BOOL KeyCodeToKeyName(KeyCode nCode, CString &strKeyName);
BOOL ModifierToModifierName(UINT nModifier, CString &strModifier);